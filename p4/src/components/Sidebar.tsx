  ...
  return (
    <aside className="w-64 bg-white shadow-xl shadow-gray-200/50 flex flex-col h-full z-20 border-r border-gray-100">
      ...
      <div className="p-4 border-t border-gray-100 flex flex-col gap-1.5 bg-gray-50/50">
        <button className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-white hover:text-blue-600 hover:shadow-sm hover:shadow-gray-200/50 transition-all group">
        ...
        <button className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-red-50 hover:text-red-600 transition-all group">
